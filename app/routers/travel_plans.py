...
from app.models import (
    TravelPlan, TravelPlanCreate, TravelPlanUpdate, TravelPlanResponse,
...
async def update_travel_plan(
    ...
    try:
        ...
        if 'itinerary' in update_data and update_data['itinerary']:
            update_data['itinerary'] = json.dumps(update_data['itinerary'], ensure_ascii=False)
